...
"""
detection-result 每张图片一个txt文件，
每个box对应一行分别对应 label(类别名称不是对应的数字编号), confidence，xmin, ymin, xmax, ymax 
gt也是同样的
每个box对应txt文件中的一行 label(类别名称不是对应的数字编号), xmin, ymin, xmax, ymax, difficult(这个可以没有)
"""
def voc_ap(rec, prec):
    """
