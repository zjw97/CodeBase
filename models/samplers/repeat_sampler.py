...
if __name__ == "__main__":
    ...
    config = EasyDict({
        ...
        "POW": 0.5,
        "MAX_REPEAT_TIMES": 10000.0,
        "MIN_REPEAT_TIMES": 1.0
    })
    from torch.utils.data import DataLoader
    from torchvision.datasets.coco import CocoDetection
    data_path = "/home/zjw/Datasets/coco2017/train2017"
    anno_path = "/home/zjw/Datasets/coco2017/annotations/instances_train2017.json"
    dataset = CocoDetection(root=data_path, annFile=anno_path)
    dataloader = DataLoader(dataset, shuffle=False, num_workers=0, collate_fn=collate,
                          sampler=RepeatFactorTrainingSampler(dataset,
                                                              config=config,
                                                              num_replicas=2,
                                                              rank=0,
                                                              shuffle=False))
